...
export default function Player() {
  const {songName, artist, added, duration, played, img, playing, volume, setVolume, setPlayed, toggleAdded, togglePlaying} = useUserStore((store)=>store)
    ...
    <div className="player-container">
      ...
      <div className="play-container">
        <div className="flex play-btns">
          ...
          <button onClick={()=>togglePlaying(!playing)} className="large-btn play-btn">
            {playing ? (
        ...
        <div className="flex duration">
            ...
            <div className="flex duration">
                <img src={volume[0] === 0 ? Sound : SoundFull} alt="sound" className="small-btn"/>
                <p className="volume-slider"><Slider value={volume} onValueChange={setVolume}/></p>
            </div>
        </div>
      </div>
    </div>
